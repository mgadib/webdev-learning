    ...
    <footer className="w-full border-t border-app-default bg-app-surface mt-auto transition-normal">
      <div className="max-w-content mx-auto px-6 py-6">
        <div className="flex flex-col sm:flex-row justify-between items-center gap-3">
          <span className="font-body text-[13px] font-semibold text-app-heading flex items-center gap-2">
            <GraduationCap size={20} strokeWidth={1.7} className="text-app-accent shrink-0" />
            Webdev Learning
          </span>
